...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dra. María de los Ángeles Campaña" },
      {
        property: "og:title",
      ...
      { property: "og:site_name", content: "gastroenquito.com" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;1,9..144,400;1,9..144,500&family=Manrope:wght@300;400;500;600;700;800&display=swap",
      },
    ],
  }),
